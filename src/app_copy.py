...
SWAGGER_URL = '/appservice/swagger'
...
@app.route('/appservice/get/data')
def get_all_data():
    """Retrieve all data."""
    return jsonify(read_data())

@app.route('/appservice/get/data/<int:data_id>')
...
@app.route('/appservice/add/data', methods=['POST'])
def add_data():
    """Add new data."""
...
@app.route('/appservice/update/data/<int:data_id>', methods=['PUT'])
...
@app.route('/appservice/delete/data/<int:data_id>', methods=['DELETE'])
